...
<main style="background-image:url('/bgpup3.jpg'); background-repeat:no-repeat; background-size:cover; min-height: 85vh; padding: 5%;">
    ...
    <div class="container" style="width:75%">
        <div class="bg-light" style="padding:5%">
            ...
            <form method="POST" action="{{ route('outsider.transaction.new') }}">
                @csrf
                <div class="row mb-3">
                    <div class="col-md-12">
                        <label for="name" name="name" id="name">Name: </label>
                        <input class="form-control" type="text" name="name" id="name" placeholder="Name" aria-label="default input example">
                    </div>
                    <div class="col-md-12">
                        <label for="contact" name="contact" id="contact">Contact: </label>
                        <input class="form-control" type="text" name="contact" id="contact" placeholder="Contact" aria-label="default input example">
                    </div>
                </div>
