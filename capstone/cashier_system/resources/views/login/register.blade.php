                ...
                <div class="card-body">
                    ...
                    <form action="#" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" id="name" placeholder="Middle Name" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" id="name" placeholder="Suffix" required>
                        </div>
                        <div class="mb-3">
